...
const dentalWebsiteSectionsComponent = [
  ...
  // AI-GENERATED SERVICES SECTION
  {
    id: 'react-ai-services-section',
    name: 'AI-Generated Services Section',
    category: 'services',
    description: 'Dynamic services section displaying AI-generated service content integrated into your website',
    tags: ['dental', 'services', 'ai-generated', 'dynamic', 'react'],
    ...
    configOptions: [
      {
        key: 'maxServices',
        label: 'Maximum Services to Show',
        type: 'number',
        min: 3,
        max: 12,
        default: 6
    ...
    component: `<!-- This is a React component that will be rendered dynamically -->`
  }
];

// Export the dynamic service generator function for use in other components
export { generateDynamicServicesDropdown };

export default dentalWebsiteSectionsComponent;